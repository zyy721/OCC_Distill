...
class BEVStereo4DOCCRender(BEVStereo4DOCC):
    """Add the rendering loss as the auxiliary loss for the BEVStereo4DOCC model.
    ...
    def __init__(self,
                 ...
                 use_render_semantic_loss=False,
                 **kwargs):
        
        super(BEVStereo4DOCCRender, self).__init__(**kwargs)

        self.use_render_depth_loss = use_render_depth_loss
        self.use_render_semantic_loss = use_render_semantic_loss
        ...
        assert not self.NeRFDecoder.img_recon_head, \
            "The image reconstruction head is not supported in this model."
    ...
    def forward_train(self,
        ...
        if self.num_random_view != -1:
            rand_ind = torch.multinomial(torch.tensor(
                [1/self.num_random_view]*self.num_random_view), 
...
@DETECTORS.register_module()
class BEVStereo4DSSCOCCNeRF(BEVStereo4D):
    """The BEVDet with SSCNet and lovasz loss, and with the nerf head.
    """
    ...
    def simple_test(self,
        ...
        if VISUALIZE:
            ...
            visualizer.visualize_gt_occ(self.NeRFDecoder, 
                                        ...
                                        save_dir="./results/AAAI_visualization/student-4264-depth-new")
            exit()

...
###################################################
# set whether use private testing dataset, this will modify the CustomNuPlanDataset.
...
train_pipeline = [
    ...
    dict(type='LoadNuPlanPointsFromFile',
         coord_type='LIDAR',
         use_pred_pc=True,
         pred_pc_data_root="data/vidar_pred_pc_train",
         use_dim=[0, 1, 2]),
...
test_pipeline = [
    ...
    dict(type='LoadNuPlanPointsFromFile',
         coord_type='LIDAR',
         use_pred_pc=True,
         pred_pc_data_root="data/vidar_pred_pc_new",
         use_dim=[0, 1, 2]),
    dict(type='PointsRangeFilter', point_cloud_range=point_cloud_range),
    dict(type='PointsConditionalFlip'),
    dict(
...
load_from = "work_dirs/openscene-fusion-occ-stbase-4d-stereo-24e-use-pred-pc-partial/epoch_11_ema.pth"

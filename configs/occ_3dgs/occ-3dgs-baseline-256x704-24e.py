...
Date: 2024-01-31 11:42:34
Email: haimingzhang@link.cuhk.edu.cn
Description: Using the volume feature to predict the gaussian parameters.
'''
...
model = dict(
    ...
    img_neck=dict(
        ...
        start_level=0,
        out_ids=[0]),
    ## the 3DGS decoder head
    render_head=dict(
        type='GaussianSplattingDecoder',
        use_gs_predictor=True,
